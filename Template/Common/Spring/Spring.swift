...
@objc public protocol Springable {
    ...
    var isAnimationInProgress: Bool { get set }
...
public class Spring : NSObject {
    ...
    private var isRemovedOnCompletion: Bool { set { self.view.isRemovedOnCompletion = newValue } get { return self.view.isRemovedOnCompletion }}
    ...
    func animatePreset() {
        ...
        if let animation = AnimationPreset(rawValue: animation) {
            ...
            case .Morph:
                ...
                morphX.isRemovedOnCompletion = isRemovedOnCompletion
                ...
                morphY.isRemovedOnCompletion = isRemovedOnCompletion
    ...
    func setView(completion: @escaping () -> ()) {
        ...
        let isRemovedOnCompletion = self.isRemovedOnCompletion
